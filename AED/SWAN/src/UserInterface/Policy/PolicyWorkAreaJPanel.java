 ...
 * @author Jiya
 */
public class PolicyWorkAreaJPanel extends javax.swing.JPanel {
    ...
    int wfh;
    public PolicyWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, PolicyOrganization organization, Enterprise enterprise,int wfh) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Policy WorkArea");
    ...
    private void btnWorkRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnWorkRequestActionPerformed
        ...
        ServePolicyWorkRequestJPanel servePolicyWorkRequestJPanel = new ServePolicyWorkRequestJPanel(userProcessContainer,userAccount,organization,wfh);
        userProcessContainer.add("ServePolicyWorkRequestJPanel",servePolicyWorkRequestJPanel);
    ...
    private void btnMyWorkRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMyWorkRequestActionPerformed
        ...
        ServeMyWorkRequestPolicyJPanel serveMyWorkRequestPolicyJPanel = new ServeMyWorkRequestPolicyJPanel(userProcessContainer,userAccount,wfh);
        userProcessContainer.add("ServeMyWorkRequestPolicyJPanel",serveMyWorkRequestPolicyJPanel);
        CardLayout cl = (CardLayout)userProcessContainer.getLayout();
        cl.next(userProcessContainer);
    ...
    private void btnTmeSheetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTmeSheetActionPerformed
        ...
        TimesheetJPanel timesheetPolicyJPanel = new TimesheetJPanel(userProcessContainer,userAccount,wfh);
        userProcessContainer.add("TimesheetPolicyJPanel",timesheetPolicyJPanel);
        CardLayout cl = (CardLayout)userProcessContainer.getLayout();
        cl.next(userProcessContainer);
