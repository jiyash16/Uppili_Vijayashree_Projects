...
public class ViewPatientDirectoryJPanel extends javax.swing.JPanel {
    ...
    public ViewPatientDirectoryJPanel(JPanel userProcessContainer,Enterprise enterprise) {
        initComponents();
    ...
    private void btnViewProfileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewProfileActionPerformed
        ...
        if(selectedrow < 0)
        {
            JOptionPane.showMessageDialog(null,"Please select any row to view","Information",JOptionPane.INFORMATION_MESSAGE);
            return;
        }
