    ...
    private void btnviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnviewActionPerformed
      ...
      //  System.out.println("org name" + org.getName());
        ...
        cmbPerson.setEnabled(false);
            ...
            cmbPerson.setSelectedItem(ua.getEmployee());
            ...
            if(booluserName )
            {
                if(uidpresent)
                {
                    ...
                    Role role = (Role) cmbRole.getSelectedItem();
                        ...
                        Employee employee = (Employee) cmbPerson.getSelectedItem();

                    
                        txtUsername.setBackground(Color.WHITE);

                        System.out.println("Temporary userid and Password for "+ employee.getFirstName()  + " is :["+userName +"], [ "+password + "]");
