...
import UserInterface.OrganizationAdmin.Reports.*;
 ...
 * @author Jiya
 */
public class SupportEmployeesNotFilledTimesheetJPanel extends javax.swing.JPanel {
    ...
    public SupportEmployeesNotFilledTimesheetJPanel(JPanel userProcessContainer, Enterprise enterprise) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblTimeSheet.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lblTimeSheet.setForeground(new java.awt.Color(255, 255, 255));
        lblTimeSheet.setText("TimeSheet Status");
        add(lblTimeSheet, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 40, 320, 40));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 100, -1, 380));
