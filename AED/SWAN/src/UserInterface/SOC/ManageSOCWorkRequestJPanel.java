 ...
 * @author Jiya
 */
public class ManageSOCWorkRequestJPanel extends javax.swing.JPanel {
    ...
    EcoSystem system;
    public ManageSOCWorkRequestJPanel(JPanel userProcessContainer,UserAccount userAccount, Organization organization, EcoSystem system) {
        initComponents();
    ...
    private void initComponents() {
        ...
        if (tblAdminWorkrequest.getColumnModel().getColumnCount() > 0) {
            tblAdminWorkrequest.getColumnModel().getColumn(0).setPreferredWidth(10);
            tblAdminWorkrequest.getColumnModel().getColumn(5).setPreferredWidth(50);
        }

        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 60, 880, 260));
        ...
        add(btnReject, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 340, 150, -1));
        ...
        add(btnApprove, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 340, 150, -1));
        ...
        add(btnview, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 400, -1, -1));
    ...
    private void btnRejectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRejectActionPerformed
        ...
        for(int i = 0; i <= rowcount ; i++)
        {
            ...
            if(chkbox != null && chkbox.equals(true) && status.equalsIgnoreCase("Approved Admin"))
            {
           
              //  c.setEnabled(true);
                 wr.setStatus("Rejected SOC");
                 wr.setSocApprovalStatus("Rejected");
            }
      ...
      //  System.out.println("rowcount"+rowcount);
        ...
        for(int i = 0; i < rowcount ; i++)
        {
         //   System.out.println("row"+i +" selected value" + tblAdminWorkrequest.getValueAt(i, 0));
            ...
            if(chkbox != null && chkbox.equals(true) && status.equalsIgnoreCase("Approved Admin"))
            {
                 wr.setSocApprovalStatus("Approved");
                 wr.setStatus("Approved SOC");
