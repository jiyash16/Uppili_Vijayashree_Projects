 ...
 * @author Jiya
 */
public class PatientClaimDetailsJPanel extends javax.swing.JPanel {
    ...
    public PatientClaimDetailsJPanel(JPanel userProcessContainer, Patient p) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnNewClaim = new javax.swing.JButton();
        ...
        add(btnView, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 300, 130, -1));
        ...
        AddClaimPanel.add(btnSave2, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 160, -1, -1));
        ...
        btnNewClaim.setBackground(new java.awt.Color(255, 102, 102));
        btnNewClaim.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnNewClaim.setForeground(new java.awt.Color(255, 255, 255));
        btnNewClaim.setText("New Claim");
        btnNewClaim.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnNewClaimActionPerformed(evt);
            }
        });
        add(btnNewClaim, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 270, 130, -1));
       ...
       String claimAmount = txtClaimAmount.getText().trim();
        ...
        if( !claimAmount.isEmpty() && !Diagonosis.isEmpty() && cmbInsurance.getSelectedItem() !=null )
        {
            if(boolclaimAmt && booldiagonosis)
            {
                ...
                Claim claim = patient.getClaimDirectory().createClaim();
                claim.setCreatedOn(date);
                claim.setClaimAmount(Double.parseDouble(claimAmount));
                claim.setInsurancePolicy((InsurancePolicy)cmbInsurance.getSelectedItem());
                claim.setCoPay(Integer.parseInt(txtCoPay.getText().trim()));
                claim.setDiagonosis(Diagonosis);
                JOptionPane.showMessageDialog(null,"Claim added succesfully","Succes",1);
                //   txtOrganizationName1.setText("");
                AddClaimPanel.setVisible(false);
                txtCoPay.setText("");
                txtDiagonosis1.setText("");
    ...
    private void btnNewClaimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNewClaimActionPerformed
        // TODO add your handling code here:
    ...
    }//GEN-LAST:event_btnNewClaimActionPerformed
    ...
    private javax.swing.JPanel AddOrganizationJPanel1;
    private javax.swing.JButton btnBack;
    private javax.swing.JButton btnDelete;
    private javax.swing.JButton btnNewClaim;
    ...
    private javax.swing.JLabel lblAddOrganization1;
