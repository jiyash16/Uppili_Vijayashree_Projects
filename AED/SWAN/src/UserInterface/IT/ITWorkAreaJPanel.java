...
public class ITWorkAreaJPanel extends javax.swing.JPanel {
    ...
    int wfh;
    public ITWorkAreaJPanel(JPanel userProcessContainer,UserAccount userAccount, ITOrganization organization, Enterprise enterprise,int wfh) {
        initComponents();
    ...
    private void btnWorkRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnWorkRequestActionPerformed
        ...
        ServeITWorkRequestJPanel serveITWorkRequestJPanel = new ServeITWorkRequestJPanel(userProcessContainer,userAccount,organization,wfh);
        userProcessContainer.add("ServeITWorkRequestJPanel",serveITWorkRequestJPanel);
    ...
    private void btnMyWorkRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMyWorkRequestActionPerformed
        ...
        ServeMyWorkRequestITJPanel serveMyWorkRequestITJPanel = new ServeMyWorkRequestITJPanel(userProcessContainer,userAccount,wfh);
        userProcessContainer.add("ServeMyWorkRequestITJPanel",serveMyWorkRequestITJPanel);
        CardLayout cl = (CardLayout)userProcessContainer.getLayout();
        cl.next(userProcessContainer);
    ...
    private void btnTmeSheetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTmeSheetActionPerformed
        ...
        TimesheetJPanel timesheetITJPanel = new TimesheetJPanel(userProcessContainer,userAccount,wfh);
        userProcessContainer.add("TimesheetITJPanel",timesheetITJPanel);
        CardLayout cl = (CardLayout)userProcessContainer.getLayout();
        cl.next(userProcessContainer);
