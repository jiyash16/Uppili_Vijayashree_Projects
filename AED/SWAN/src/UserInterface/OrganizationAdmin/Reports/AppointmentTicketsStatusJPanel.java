 ...
 * @author Jiya
 */
public class AppointmentTicketsStatusJPanel extends javax.swing.JPanel {
    ...
    public AppointmentTicketsStatusJPanel(JPanel userProcessContainer, Enterprise enterprise) {
        initComponents();
    ...
    public void populateChart()
    {
        ...
        for(Organization o : enterprise.getOrganizationDirectory().getOrganizationList())
        {
            if(o instanceof ReceptionistOrganization)
            {
                    for(WorkRequest wr : o.getWorkQueue().getWorkRequestList())
                    {
                        ...
                        {
                          if(wr.getStatus().equalsIgnoreCase("Booked"))
                          {
                              i++;
                          }
                          ...
                          else if(wr.getStatus().equalsIgnoreCase("Pending Nurse") || wr.getStatus().equalsIgnoreCase("Pending"))
                          {
                              k++;
                          }
                          else if(wr.getStatus().equalsIgnoreCase("Room Alloted"))
                          {
                              l++;
                          }
                          else if(wr.getStatus().equalsIgnoreCase("Completed"))
                          {
                              m++;
                          }
                       }
        ...
        bChartTicket.setValue(l, "Tickets", "Room Alloted");
         bChartTicket.setValue(k, "Tickets", "Pending Nurse");
         bChartTicket.setValue(m, "Tickets", "Completed");
         bChartTicket.setValue(i, "Tickets", "Booked");
         bChartTicket.setValue(j, "Tickets", "Cancelled");
